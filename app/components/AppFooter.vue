...
<template>
  <footer class="border-default mt-16 hidden border-t md:block">
    <div class="text-muted mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-6 text-sm">
