...
const checkUrl = computed(() => translationCheckUrl(isOriginalLanguage(current.value) ? undefined : current.value))
const fixUrl = computed(() => translationFixUrl(isOriginalLanguage(current.value) ? undefined : current.value))
    ...
    <section id="help" class="border-default bg-muted mt-10 rounded-lg border p-5">
      ...
      <div class="flex flex-wrap gap-2">
        <UButton
          ...
          :label="$t('translations.checkAction')"
          size="sm"
        />
        <UButton
          :to="fixUrl"
          ...
          :label="$t('translations.fixAction')"
          color="neutral"
          variant="subtle"
          size="sm"
        />
